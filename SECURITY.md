...
When using Common System in your projects:

- Always use the latest stable release
- Monitor the [GitHub Security Advisories](https://github.com/kcenon/common_system/security/advisories) page for updates
