...
/**
 * @file error.cppm
 * @brief C++20 module partition for error codes.
 *
 * This module partition exports centralized error code registry for all systems.
...
export namespace kcenon::common::error {
