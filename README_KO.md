...
- **프로덕션 준비**: 80%+ 테스트 커버리지, 제로 sanitizer 경고, 완전한 CI/CD
- **범용 호환성**: C++17 표준, 선택적 C++20 기능 지원
...
[🏗️ 전체 아키텍처 가이드 →](docs/01-ARCHITECTURE_KO.md)

## 빠른 시작

### 시스템 요구사항

- **컴파일러**: C++17 호환 (GCC 7+, Clang 5+, MSVC 2017+) - C++20 권장
...
- [아키텍처 개요](docs/01-ARCHITECTURE_KO.md) - 시스템 설계 및 원칙
